...
def main():
    ...
    print(logo)
    print('-------------------------------------------')
    print('\033[91;1m  Don >>  Guru Legend  ')
    print('-------------------------------------------')
    print('\033[1;35;40m                                                               -  ')                                                                  
    print('\033[1;35;40m                                                              .-  ')                                                                
    print('\033[1;35;40m                                                              %.  ')                                                                
    ...
    print('\033[1;35;40m                                                                                                      .:--==----:.            ')       
    print('\033[1;35;40m✂┄┄┄┄┄┄┄┄┄┄┄┄┄┄        ')                                                             
    print('\033[1;35;40mL3GEND GURU H3R3 [ # ] ')
    ...
    print('\033[1;35;40mL3G3ND GURU EXIT.COM ')
    coki = input(' [+] Cookies : ')
    cookies={'cookie': coki}
    ...
    try:
        for msgs in mess:
            try:
                ...
                print(' \033[91;1m[+] Guru Legend :\033[93;1m ' +hater+msgs+'\x1b[1;97m')
                print('-------------------------------------------')
